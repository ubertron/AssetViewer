#!/usr/bin/env python3
"""This script works despite PyCharm throwing warnings for arguments that appear to be valid"""
...
class SceneModifier(QtCore.QObject):
    def __init__(self, root_entity=None):
        ...
        self.m_torus = Qt3DExtras.QTorusMesh(radius=1.0, minorRadius=0.4, rings=100, slices=20)
        self.torusTransform = Qt3DCore.QTransform(scale=2.0, rotation=QtGui.QQuaternion.fromAxisAndAngle(
            QtGui.QVector3D(0.0, 1.0, 0.0), 25.0), translation=QtGui.QVector3D(5.0, 4.0, 0.0))
        ...
        self.cone = Qt3DExtras.QConeMesh(topRadius=0.5, bottomRadius=1, length=3, rings=50, slices=20)
        self.coneTransform = Qt3DCore.QTransform(scale=1.5, rotation=QtGui.QQuaternion.fromAxisAndAngle(
            QtGui.QVector3D(1.0, 4.0, -1.5), 45.0),translation=QtGui.QVector3D(0.0, 4.0, -1.5))
        ...
        self.cylinder = Qt3DExtras.QCylinderMesh(radius=1, length=3, rings=100, slices=20)
        self.cylinderTransform = Qt3DCore.QTransform(scale=1.5, rotation=QtGui.QQuaternion.fromAxisAndAngle(
            QtGui.QVector3D(1.0, 0.0, 0.0), 45.0), translation=QtGui.QVector3D(-5.0, 4.0, -1.5))
        self.cylinderMaterial = Qt3DExtras.QPhongMaterial(diffuse=QtGui.QColor("#928327"))
        ...
        self.planeTransform = Qt3DCore.QTransform(scale=1.3, rotation=QtGui.QQuaternion.fromAxisAndAngle(
            QtGui.QVector3D(1.0, 0.0, 0.0), 45.0), translation=QtGui.QVector3D(0.0, -4.0, 0.0))
        ...
        self.sphereTransform = Qt3DCore.QTransform(scale=1.3, translation=QtGui.QVector3D(-5.0, -4.0, 0.0))
